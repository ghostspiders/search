...
package org.server.search.client.transport.action.search;
...
public class ClientTransportSearchAction extends BaseClientTransportAction<SearchRequest, SearchResponse> {

    @Inject public ClientTransportSearchAction(Settings settings, TransportService transportService) {
        super(settings, transportService, SearchResponse.class);
    }

    @Override protected String action() {
        return TransportActions.SEARCH;
    }
}