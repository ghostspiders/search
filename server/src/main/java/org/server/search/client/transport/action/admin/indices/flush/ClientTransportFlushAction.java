...
package org.server.search.client.transport.action.admin.indices.flush;
...
public class ClientTransportFlushAction extends BaseClientTransportAction<FlushRequest, FlushResponse> {
    ...
    @Inject public ClientTransportFlushAction(Settings settings, TransportService transportService) {
