...
public class AnalysisModule extends AbstractModule {
    ...
    @Override protected void configure() {
        ...
        for (Map.Entry<String, Settings> entry : tokenFiltersSettings.entrySet()) {
            ...
            Class<? extends TokenFilterFactory> type = tokenFilterSettings.getAsClass("type", null, "org.server.search.index.analysis.", "TokenFilterFactory");
            if (type == null) {
        ...
        for (Map.Entry<String, Settings> entry : tokenizersSettings.entrySet()) {
            ...
            Class<? extends TokenizerFactory> type = tokenizerSettings.getAsClass("type", null, "org.server.search.index.analysis.", "TokenizerFactory");
            if (type == null) {
        ...
        for (Map.Entry<String, Settings> entry : analyzersSettings.entrySet()) {
            ...
            Class<? extends AnalyzerProvider> type = analyzerSettings.getAsClass("type", null, "org.server.search.index.analysis.", "AnalyzerProvider");
            if (type == null) {
