...
import org.server.search.index.cache.filter.soft.SoftFilterCache;
...
public class FilterCacheModule extends AbstractModule {
    ...
    @Override protected void configure() {
        bind(FilterCache.class)
                .to(settings.getAsClass(FilterCacheSettings.FILTER_CACHE_TYPE, SoftFilterCache.class, "org.server.search.index.cache.filter.", "FilterCache"))
                .in(Scopes.SINGLETON);
    }
}
