...
package org.server.search.index.store;

import com.google.inject.AbstractModule;
import com.google.inject.Module;
import org.server.search.index.store.bytebuffer.ByteBufferStoreModule;
import org.server.search.index.store.fs.MmapFsStoreModule;
import org.server.search.index.store.fs.NioFsStoreModule;
import org.server.search.index.store.fs.SimpleFsStoreModule;
import org.server.search.index.store.memory.MemoryStoreModule;
import org.server.search.index.store.ram.RamStoreModule;
import org.server.search.util.OsUtils;
...
public class StoreModule extends AbstractModule {
    ...
    @Override protected void configure() {
        ...
        if ("ram".equalsIgnoreCase(storeType)) {
            ...
            storeModule = settings.getAsClass("index.store.type", storeModule, "org.server.search.index.store.", "StoreModule");
        }
