...
import static org.server.search.util.jline.ANSI.Code.FG_BLUE;
import static org.server.search.util.jline.ANSI.Code.FG_CYAN;
import static org.server.search.util.jline.ANSI.Code.FG_GREEN;
import static org.server.search.util.jline.ANSI.Code.FG_RED;
import static org.server.search.util.jline.ANSI.Code.FG_YELLOW;
import static org.server.search.util.jline.ANSI.Code.OFF;
