...
import org.server.search.util.settings.loader.SettingsLoader;
import org.server.search.util.settings.loader.SettingsLoaderFactory;
...
public class ImmutableSettings implements Settings {
    ...
    @Override public Settings getComponentSettings(Class component) {
        return getComponentSettings("org.server.search", component);
    }
